...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("OnlinrOrderApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("OnlinrOrderApplication");
        ...
        config.getMapConfigs().put("com.ramintech.onlinrorder.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
